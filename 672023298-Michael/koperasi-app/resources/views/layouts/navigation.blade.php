                ...
                <div class="shrink-0 flex items-center">
                    ...
                    <a href="{{ route('dashboard') }}"
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="text-blue-700 text-2xl font-extrabold tracking-wide leading-none">
                                BANK CENTRAL
                            </span>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="trigger">
                        ...
                        <button
                            class="flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg shadow transition duration-300">
                    ...
                    <x-slot name="content">
                        ...
                        <form method="POST"
                            ...
                            <x-dropdown-link :href="route('logout')"
                                class="text-red-600 hover:bg-red-100 font-semibold"
