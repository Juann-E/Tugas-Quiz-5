...
<head>
    ...
    <style>
        ...
        .btn-login { background-color: #0d6efd; color: white; border-radius: 6px; }
    </style>
</head>
<body>
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white border-bottom-0 pt-4 pb-0">
            <h5 class="mb-0 text-muted" style="font-size: 16px;">Login</h5>
            <hr class="mt-2 mb-0">
        </div>
        <div class="card-body p-4">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="text-center">
                    <span class="text-muted" style="font-size: 14px;">Belum punya akun? <a href="{{ route('register') }}" class="text-decoration-none">Daftar di sini</a></span>
                </div>
            </form>
        </div>
    </div>
