...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <form method="POST" action="{{ route('transaction.save') }}">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" placeholder="Masukkan keterangan penabungan..."></textarea>
                    @error('description')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>

                <button type="submit">Tabung Sekarang</button>
            </form>
        </div>
    </div>
</body>
