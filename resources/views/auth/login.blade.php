...
<div class="w-full max-w-sm">
    ...
    <div class="text-center mb-7">
        ...
        <h1 class="font-display text-2xl text-gray-800 leading-snug">
            Masuk ke Akun<br><em class="text-emerald-600">Anda</em>
        </h1>
        <p class="text-sm text-gray-400 mt-1.5 font-light">Gunakan kredensial yang telah didaftarkan</p>
    </div>
    ...
    <div class="card-shadow rounded-2xl bg-white p-8">
        ...
        <p class="text-center text-sm text-gray-400">
            Belum punya akun?
            <a href="{{ route('register') }}" class="text-emerald-600 hover:text-emerald-700 font-semibold transition-colors duration-150 ml-1">
                Daftar di sini →
            </a>
        </p>
