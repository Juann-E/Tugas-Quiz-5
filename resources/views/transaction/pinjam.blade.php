...
<div class="w-full max-w-sm">
    ...
    <div class="text-center mb-7">
        <div class="inline-flex items-center justify-center w-11 h-11 rounded-xl bg-amber-50 border border-amber-100 mb-4">
        ...
        <h1 class="font-display text-2xl text-gray-800 leading-snug">
            Ajukan <em class="text-amber-600">Pinjaman</em>
        </h1>
        <p class="text-sm text-gray-400 mt-1.5 font-light">Masukkan jumlah yang ingin dipinjam</p>
    </div>
    ...
    <div class="card-shadow rounded-2xl bg-white p-8">
        ...
        {{-- Info notice --}}
        <div class="mb-5 rounded-xl bg-amber-50 border border-amber-100 px-4 py-3 flex gap-3 items-start">
            <svg class="shrink-0 mt-0.5" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#d97706" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <form action="{{ route('pinjam.process') }}" method="POST" class="space-y-5">
            @csrf
            ...
            <div class="pt-1 space-y-3">
                <button type="submit" class="btn-warning w-full rounded-xl py-3 text-sm font-semibold text-white tracking-wide">
                    Ajukan Pinjaman
                </button>
